<?php /* Smarty version 2.6.11, created on 2012-10-27 19:43:57
         compiled from modules/Leads/tpls/ConvertLead.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'modules/Leads/tpls/ConvertLead.tpl', 41, false),array('function', 'sugar_field', 'modules/Leads/tpls/ConvertLead.tpl', 99, false),array('function', 'sugar_evalcolumn', 'modules/Leads/tpls/ConvertLead.tpl', 166, false),array('modifier', 'strtoupper', 'modules/Leads/tpls/ConvertLead.tpl', 94, false),array('modifier', 'count', 'modules/Leads/tpls/ConvertLead.tpl', 122, false),)), $this); ?>
{*
/*********************************************************************************
...
');<?php if (! empty ( $this->_tpl_vars['def']['select'] )): ?>toggle<?php echo $this->_tpl_vars['module']; ?>
Select();<?php endif; ?>">
<script type="text/javascript">
...
">
<?php echo smarty_function_sugar_field(array('parentFieldArray' => 'contact_def','vardef' => $this->_tpl_vars['contact_def'][$this->_tpl_vars['def']['select']],'displayType' => 'EditView','displayParams' => $this->_tpl_vars['displayParams'],'formName' => $this->_tpl_vars['form_name'],'call_back_function' => 'set_return_lead_conv'), $this);?>

<script>
if (typeof(sqs_objects) == "undefined") sqs_objects = [];
sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['def']['select']; ?>
'] = {ldelim}
...
'],
    group         : 'or',
    field_list    : ['name', 'id'],
    populate_list : ['<?php echo $this->_tpl_vars['def']['select']; ?>
', '<?php echo $this->_tpl_vars['contact_def'][$this->_tpl_vars['def']['select']]['id_name']; ?>
'],
    conditions    : [{ldelim}'name':'name','op':'like','end':'%','value':''{rdelim}],
    required_list : ['<?php echo $this->_tpl_vars['contact_def'][$this->_tpl_vars['def']['select']]['id_name']; ?>
'],
    order         : 'name',
    limit         : '10'
{rdelim}
