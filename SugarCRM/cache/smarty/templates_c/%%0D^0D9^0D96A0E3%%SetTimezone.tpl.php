<?php /* Smarty version 2.6.11, created on 2012-10-26 16:19:34
         compiled from modules/Users/SetTimezone.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'modules/Users/SetTimezone.tpl', 65, false),)), $this); ?>
<!--
/*********************************************************************************
...
<table class="subMenuTD" style="padding: 8px; border: 2px solid #999; background-color: #fff;" cellpadding="0" cellspacing="2" border="0" align="center" width="440">
	...
	<tr>
		<td colspan="2" width="100%" style="font-size: 12px; padding-bottom: 5px;">
			...
			<tr>
				<td colspan="2"><slot><?php echo $this->_tpl_vars['MOD']['LBL_PICK_TZ_DESCRIPTION']; ?>
</slot></td>
			</tr>
			</table>
			<br><br>
			<slot><select tabindex='3' name='timezone'><?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['TIMEZONEOPTIONS'],'selected' => $this->_tpl_vars['TIMEZONE_CURRENT']), $this);?>
</select></slot>
