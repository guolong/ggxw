...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'cache/modules/Accounts/ConvertLead.tpl', 47, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/ConvertLead.tpl', 71, false),array('function', 'counter', 'cache/modules/Accounts/ConvertLead.tpl', 107, false),array('modifier', 'default', 'cache/modules/Accounts/ConvertLead.tpl', 97, false),array('modifier', 'strip_semicolon', 'cache/modules/Accounts/ConvertLead.tpl', 103, false),)), $this); ?>
...
<input class="checkbox" type="checkbox" name="newAccounts" id="newAccounts" onclick="toggleDisplay('createAccounts');if (typeof(addRemoveDropdownElement) == 'function') addRemoveDropdownElement('Accounts');toggleAccountsSelect();">
<script type="text/javascript">
