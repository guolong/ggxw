...
<input class="checkbox" type="checkbox" name="newCalls" id="newCalls" onclick="toggleDisplay('createCalls');if (typeof(addRemoveDropdownElement) == 'function') addRemoveDropdownElement('Calls');">
<script type="text/javascript">
