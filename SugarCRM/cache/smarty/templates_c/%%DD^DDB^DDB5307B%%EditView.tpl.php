...
<table width="100%" border="0" cellspacing="1" cellpadding="0"  id='LBL_MEETING_INFORMATION'  class="edit view panelContainer">
...
<td valign="top" id='add_parent_invitee_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ADD_PARENT_INVITEE','module' => 'Meetings'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<a id="add_parent_invitee" style="color:#0B578F; text-decoration:underline; cursor:pointer" onclick="SugarWidgetSchedulerAttendees.formAddParent();"><?php echo $this->_tpl_vars['MOD']['LBL_ADD_PARENT_INVITEE']; ?>
</a>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0):  echo $this->_tpl_vars['tableRow']; ?>
...
addToValidate(\'EditView\', \'add_parent_invitee\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ADD_PARENT_INVITEE','module' => 'Meetings','for_js' => true), $this); echo '\' );
