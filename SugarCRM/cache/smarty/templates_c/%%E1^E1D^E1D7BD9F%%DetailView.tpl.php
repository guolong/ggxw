<?php /* Smarty version 2.6.11, created on 2012-10-30 13:59:32
         compiled from cache/modules/Leads/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'cache/modules/Leads/DetailView.tpl', 7, false),array('modifier', 'strip_semicolon', 'cache/modules/Leads/DetailView.tpl', 95, false),array('modifier', 'substr', 'cache/modules/Leads/DetailView.tpl', 302, false),array('modifier', 'to_url', 'cache/modules/Leads/DetailView.tpl', 304, false),array('modifier', 'escape', 'cache/modules/Leads/DetailView.tpl', 332, false),array('modifier', 'url2html', 'cache/modules/Leads/DetailView.tpl', 332, false),array('modifier', 'nl2br', 'cache/modules/Leads/DetailView.tpl', 332, false),array('modifier', 'strip_tags', 'cache/modules/Leads/DetailView.tpl', 338, false),array('function', 'sugar_include', 'cache/modules/Leads/DetailView.tpl', 70, false),array('function', 'counter', 'cache/modules/Leads/DetailView.tpl', 75, false),array('function', 'sugar_getimagepath', 'cache/modules/Leads/DetailView.tpl', 78, false),array('function', 'sugar_translate', 'cache/modules/Leads/DetailView.tpl', 81, false),array('function', 'sugar_getimage', 'cache/modules/Leads/DetailView.tpl', 115, false),array('function', 'sugar_phone', 'cache/modules/Leads/DetailView.tpl', 133, false),array('function', 'sugar_ajax_url', 'cache/modules/Leads/DetailView.tpl', 601, false),)), $this); ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['company_c']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_COMPANY','module' => 'Leads'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['company_c']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['company_c']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['company_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['company_c']['value']);  endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['company_c']['name']; ?>
